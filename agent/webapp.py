...
# Secrets stay as env vars (never stored in manifest YAML)
LINEAR_WEBHOOK_SECRET = os.environ.get("LINEAR_WEBHOOK_SECRET", "")
GITHUB_WEBHOOK_SECRET = os.environ.get("GITHUB_WEBHOOK_SECRET", "")
SLACK_SIGNING_SECRET = os.environ.get("SLACK_SIGNING_SECRET", "")

# Config loaded from AAP manifest with env var fallback
SLACK_BOT_USER_ID = get_slack_bot_user_id()
SLACK_BOT_USERNAME = get_slack_bot_username()
DEFAULT_REPO_OWNER = get_default_repo_owner()
DEFAULT_REPO_NAME = get_default_repo_name()
SLACK_REPO_OWNER = get_slack_repo_owner()
SLACK_REPO_NAME = get_slack_repo_name()
...
ALLOWED_GITHUB_ORGS: frozenset[str] = get_allowed_github_orgs()
